...
export default function AdminEvents({ onChanged }: { onChanged?: () => void }) {
  ...
  const save = async (e: FormEvent) => {
    ...
    try {
      const payload: EventInput = { ...form, event_date: new Date(`${form.event_date}T12:00:00`).toISOString(), description: form.description || null, location: form.location || null, banner: form.banner || null }
